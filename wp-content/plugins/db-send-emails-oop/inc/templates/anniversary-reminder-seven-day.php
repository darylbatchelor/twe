          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="80%" align="left" valign="top"><font style="font-family: Georgia, \'Times New Roman\', Times, serif; color:#010101; font-size:24px"><strong><em>Hi ' . $allusers->display_name . ',</em></strong></font><br /><br />
                  <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">Your ' . $anniversary . ' year anniversary is in ' . $days . ' days.  If you have not yet ordered your presents take a good look at yourself... we’re not angry... just disapoined... nah just kidding! It’s ok you still have some time, but you may not get your presents delivered in time from Amazon.  This means that you may need to source something locally.  Still check out out present ideas in the present pack below, but if they cannot be delivered in time go and buy them from somewhere locally. </font></td>
