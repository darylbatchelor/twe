...
Description: Adds custom templates to page builder
Plugin URI: 
Version: 1
Author: WPExplorer
Author URI: 
...
class PageTemplater {
	...
	private function __construct() {
		...
		$this->templates = array(
			'template-user-profiles.php' => 'Member\'s Account Page',
			'db-anniversary-posts.php' => 'Anniversary Posts',
		);
...
function wpsites_custom_post_type_template($single_template) {
     ...
     if ($post->post_type == 'anniversary_years' ) {
