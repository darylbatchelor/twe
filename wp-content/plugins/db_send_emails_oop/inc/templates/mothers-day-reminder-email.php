...
$subject = 'Mother\'s Day is in ' . $days . ' ' . $day_word;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#5e5544">
  <tr>
    <td><table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" align="center">
          ...
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="80%" align="left" valign="top"><font style="font-family: Georgia, \'Times New Roman\', Times, serif; color:#010101; font-size:24px"><strong><em>Hi ' . $allusers->display_name . ',</em></strong></font><br /><br />
                  <font style="font-family: Verdana, Geneva, sans-serif; color:#666766; font-size:13px; line-height:21px">Mother\'s Day is in ' . $days . ' ' . $day_word . '!  Check out the link below for some ideas.</font></td>
        ...
        $affiliate_link = "https://www.amazon.com/s/ref=nb_sb_noss?url=search-alias%3Daps&field-keywords=wife+mothers+day&tag=themanpa-20";
         ...
         $body .= '<tr>
                      ...
                      <td align="center" valign="top"><table width="108" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tr>
                          <td align="center" valign="middle" bgcolor="#b7c68b"><font style="font-family: Georgia, \'Times New Roman\', Times, serif; color:#5e5544; font-size:15px"><strong><a href="' . $affiliate_link . '" target="_blank" style="color:#5e5544; text-decoration:none"><em>for Mothers Day present ideas</em></a></strong></font></td>
                        </tr>
                        <tr>
